...
public class XeDap extends Xe {
	public XeDap(String loaixe, String bienso, String vexe, String timeIn, String timeOut, String tinhtrangVao,
			String tinhtrangRa) {
	...
	public String toString() {
		return "XeDap [loaixe=" + loaixe + ", bienso=" + bienso + ", vexe=" + vexe + ", timeIn=" + timeIn + ", timeOut="
